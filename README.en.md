...
| 🎬 **Real moving shots** | Image-to-video + seamless keyframe-chained transitions + 18 named camera presets pickable per shot + 8 one-click visual looks + per-shot redo — not a still-image slideshow |
