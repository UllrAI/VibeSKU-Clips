...
- ✂️ **Text-based video editing (v0.8.95)**: import MP4 / MOV / WebM / MKV / M4V and transcribe audio locally in the browser into a word-level timeline. Removing a sentence removes the matching picture; silence removal and word-level caption burn-in are optional. Sources stay immutable, every render becomes a separate composition for export and QC, and WebGPU falls back to compatibility mode automatically.
