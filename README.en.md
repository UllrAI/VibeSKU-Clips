...
- ✂️ **Text-based video editing (v0.8.96)**: local word-level transcription, where removing text removes the matching picture. New live cut preview, undo/redo, filler marking, pre-render diffs, SRT/VTT/JSON exports, and Agent access keep every change reviewable. Sources and earlier versions remain untouched.
