...
| 🎁 **Ad templates** | 40 end-to-end commerce recipes (Turntable Hero / Factory Story / Skeptic Flip / Live-Room Cut / Giant Product…) browsable across six groups (product showcase / presenter / story / lifestyle / promo / creative) with category-matched templates floating first; one click pre-fills script style + camera plan + visual look + caption/BGM compose config, everything still editable |
