...
const JOB_FAILURE_KEYS: Record<string, string> = {
  ...
  LK888_NOT_CONFIGURED: "ugc_work_failure_lk888_config",
  LK888_AUTH_FAILED: "ugc_work_failure_lk888_auth",
  LK888_REQUEST_REJECTED: "ugc_work_failure_lk888_request",
  LK888_INVALID_RESPONSE: "ugc_work_failure_lk888_response",
  LK888_UNREACHABLE: "ugc_work_failure_lk888_unavailable",
  LK888_UNAVAILABLE: "ugc_work_failure_lk888_unavailable",
