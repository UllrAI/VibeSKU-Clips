...
2. 在 characters 数组里输出角色设定：id（如 "char_a"）、name、gender、persona（一句话性格）、appearance（外观锚：发型+服装颜色+年龄段，用于跨镜头画面一致）。外观必须写成清爽耐看的普通人——五官端正有亲和力、皮肤自然真实不磨皮、日常妆发，禁止精修网红脸/明星脸式描述，也不要刻意丑化
  ...
  "characters": [
    {
      ...
      "appearance": "外观锚：清爽耐看的普通人+发型+服装+年龄段（如：32岁有亲和力、松散低马尾带碎发、日常淡妆、浅色居家服）"
    }
  ],
  "shots": [
    {
