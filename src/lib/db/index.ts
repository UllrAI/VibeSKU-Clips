...
// Database file path: writable data directory, configurable with APP_DATA_DIR.
...
try {
  ...
  // WAL is a persistent property of the DB file — setting it once at runtime is enough.
...
// Migrations only need to run once at runtime.
