...
export const script: NamespaceMessages = {
  zh: {
    ...
    autoModeHint: "自动完成：写脚本 → 配画面（免费素材）→ 配音合成。通常 1–3 分钟，完成后直接看成片。",
    autoModeManual: "转手动编辑",
    simpleTitle: "脚本好了",
    simpleSubtitle: "看一眼口播文案，没问题就一键成片；想换一版就重新生成",
    simpleGoPro: "进导演模式精修 →",
    // 保存模板弹窗
  ...
  en: {
    ...
    autoModeHint: "Fully automatic: script \u2192 footage (free stock) \u2192 voice-over & compose. Usually 1\u20133 minutes, then straight to the finished video.",
    autoModeManual: "Edit manually",
    simpleTitle: "Script ready",
    simpleSubtitle: "Skim the voice-over — happy? One tap to finish. Want another take? Regenerate.",
