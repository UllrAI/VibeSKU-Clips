...
export const clone: NamespaceMessages = {
  zh: {
    ...
    step1Title: "输入爆款视频",
    step1Desc: "上传文件可解析真实镜头节奏；仅粘贴链接时会载入通用结构，不会抓取平台视频。",
    videoUrlLabel: "视频链接",
    ...
    step2Title: "上传你的商品",
    step2Desc: "参考结构确认后，再补充商品图片、名称和真实卖点。",
    step2Locked: "先完成参考结构分析，商品信息随后开放。",
    productImageLabel: "商品图片",
    productImageRange: "（1–5 张）",
    uploadHint: "拖拽图片到此处，或点击上传",
    uploadFormatHint: "支持 JPG、PNG 格式，最多 5 张",
    productImageAlt: "商品图片",
    removeProductImage: "移除商品图片",
    productNameLabel: "商品名称",
    productNamePlaceholder: "例如：便携榨汁杯",
    productFeaturesLabel: "商品卖点",
    productFeaturesPlaceholder: "例如：容量、材质、续航与适用场景…",
    cloning: "正在生成参考版本…",
    startClone: "按参考结构生成脚本",
    step3Title: "生成参考脚本",
    step3Desc: "只复用节奏与结构，商品内容会重新生成；脚本仍可在下一页编辑。",
    // 分镜结构卡片
    shot1Title: "开场吸引",
    ...
    copyrightNote: "请仅使用你有权使用的素材作为参考。复刻他人视频可能涉及版权与合规风险。",
    ...
    modelTierNeedModel: "复刻要用支持参考视频的模型——到设置里把视频模型换成 Seedance 系列",
    modelTierNeedSeedance: "当前默认视频模型不支持参考生视频，请在设置中选择 Seedance 2.0 系列模型",
    modelTierBtn: "开始整片复刻",
    modelTierRunning: "正在生成成片（约 1–3 分钟）…",
  ...
  en: {
    ...
    step2Desc: "After confirming the reference structure, add product images, its name, and factual selling points.",
    step2Locked: "Analyze the reference structure first to unlock product details.",
    productImageLabel: "Product images",
    productImageRange: "(1–5 images)",
    ...
    productFeaturesPlaceholder: "For example: capacity, material, battery life, and use cases…",
    cloning: "Generating a reference-based version…",
    startClone: "Generate script from structure",
    step3Title: "Generate the reference-based script",
    step3Desc: "Only pacing and structure are reused. Product content is rewritten and remains editable on the next page.",
    // 分镜结构卡片
    ...
    copyrightNote: "Only use footage you are allowed to reference. Replicating someone else's video may involve copyright and compliance risks.",
    ...
    modelTierNeedModel: "Replication needs a model that accepts reference video — switch the video model to a Seedance one in Settings",
    ...
    modelTierBtn: "Start full-film replication",
    modelTierRunning: "Generating the video (about 1–3 minutes)…",
